...
15 tests, all offline: graph-construction invariants, GraphRAG retrieval correctness (including a regression test for the generic-symptom over-matching bug this caught during development), and a 15-case hand-labeled evaluation set (`tests/eval_set.json`) scored for accuracy the way you'd score any retrieval system — currently **100%** (15/15).
...
src/api/                       FastAPI service (/diagnose, /health)
